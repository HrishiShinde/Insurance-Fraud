import pandas as pd
import numpy as np
train_claim = pd.read_csv('Data/TrainData/Train_Claim.csv',na_values='?')
train_claim.head()
train_demo = pd.read_csv('Data/TrainData/Train_Demographics.csv')
train_policy = pd.read_csv('Data/TrainData/Train_Policy.csv')
train_target = pd.read_csv('Data/TrainData/Traindata_with_Target.csv')
...
target = pd.read_csv('Data/TrainData/Traindata_with_Target.csv')
...
import pickle
pickle.dump(dtclf,open('model_single.pkl','wb'))
